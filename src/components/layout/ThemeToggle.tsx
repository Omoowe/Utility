...
export function ThemeToggle(): React.JSX.Element {
  ...
  return (
    <button
      ...
      className="flex items-center justify-center w-9 h-9 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
    >
      {isDark ? (
